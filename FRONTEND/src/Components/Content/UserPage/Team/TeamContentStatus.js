...
import TeamContentStatusReplyInput from "./TeamContentStatusReplyInput";

export default class TeamContentStatus extends React.Component {
  constructor(props) {
    super(props);
  ...
  renderContentStatusReply = () => {
    if (this.state.setStatusReply) {
      return <TeamContentStatusReplyInput />;
    } else {
      return (
        <div
