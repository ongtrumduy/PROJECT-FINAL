               ...
               componentDidMount = () => {
                 ...
                 getAllAnswerExcerciseOfMemberContent = (
                   ...
                   let nthindex = this.state.ExcerciseAllAnswerContent.findIndex(
                     answeritem => {
                       return (
                         answeritem.ExcerciseNthQuestion ===
                         excerciseNthQuestion
                       );
                     }
                   );
                   if (nthindex >= 0) {
                     this.state.ExcerciseAllAnswerContent.splice(
                       nthindex,
                       1,
                       AnswerContent
                     );
                     this.setState({
                       ExcerciseAllAnswerContent: this.state
                         .ExcerciseAllAnswerContent,
                       checkDidAnswerQuest: false
                     });
                   } else {
                 ...
                 sendToFinishedExcerciseChoice = () => {
                   axios
                     ...
                     .then(res => {
                       ...
                       if (
                         res.data.checkValidate ===
                         "success-finished-excercise-choice"
                       ) {
                         this.props.getExcerciseDidIDMemberDone(
                           res.data.ExcerciseDidID
                         );
                         setTimeout(() => {
                     ...
                     <div className="user-excercises_do-excercise__QandA___control">
                       ...
                       <div>
                         <input
                           ...
                           value="Hoàn tất"
                           onClick={() =>
                             this.sendToCompleteDoExcerciseChoice()
                           }
                         />
                       </div>
                     </div>
                 ...
                 renderExcercisesDoExcerciseContentItem = () => {
                   let nthindex = this.props.ExcerciseAllQAContent.findIndex(
                     questansitem => {
                       return (
                     ...
                     <div>
                       ...
                       >
                         <div>
                           ...
                           <p style={{ fontWeight: "bold" }}>
                             Không thể vượt quá số lượng câu hỏi của Bộ đề - Bài
                             tập !!!!
                           </p>
                         </div>
                         <button
                       ...
                       >
                         <div>
                           ...
                           <p style={{ fontWeight: "bold" }}>
                             Bạn chưa hoàn thành nội dung cho tất cả các câu hỏi
                             có trong Bộ đề - Bài tập. Bạn có chính xác muốn nộp
                             bài không ???
                           </p>
                         </div>
                         <button
                         ...
                         <button
                           style={{ float: "right", cursor: "pointer" }}
                           onClick={() =>
                             this.closeCheckCompleteExcerciseModal()
                           }
                         >
                           Ấn nhầm!!!
                         </button>
