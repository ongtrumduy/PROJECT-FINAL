...
export default class ExcercisesOwnedDetailItem extends React.Component {
                   ...
                   axios
                     ...
                     .then(res => {
                       this.setState({
                         ...
                         ExcerciseDescription: res.data.ExcerciseDescription,
                 ...
                 sentToBeginStartDoExcercise = () => {
                   if (this.state.TimeToDoExcercise === "0") {
                     ...
                     this.props.updateRenderExcerciseControl(
                       "excercisedoexcercise"
                     );
                     this.props.getExcerciseOwnedIDMemberChoice(
                 ...
                 seenExcerciseItemScoreBoard = () => {
                   ...
                   this.props.updateRenderExcerciseOwnedControl(
                     "owneditemscoreboard"
                   );
                 };
                   ...
                   if (this.state.checkTimeToDoExcercise) {
                     return (
                       <small style={{ color: "red" }}>
                         Bạn cần chọn thời gian làm Bộ đề - Bài tập trong bao
                         lâu đã !!!
                       </small>
                     );
                   }
                     ...
                     <div>
                       ...
                       <div className="user-excercises_all-list__owned-list___owned-item_____excercise-logo-and-content">
                         <div className="user-excercises_all-list__owned-list___owned-item_____excercise-logo">
                           <img src={this.state.ExcerciseLogo} />
                         ...
                         <div className="user-excercises_all-list__owned-list___owned-item_____excercise-content">
                           ...
                           <div>
                             <button
                               ...
                               onClick={() =>
                                 this.changeCheckOwnedExcerciseItem()
                               }
                             >
                               {(this.state.checkOwnedExcerciseItem && (
                             ...
                             <button
                               ...
                               onClick={() =>
                                 this.openConfirmDoExcercisesChoiceModal()
                               }
                             >
                               <div className="user-excercises_all-list__owned-list___owned-item____button-choose">
                                 <div>
                             ...
                             <button
                               ...
                               onClick={() =>
                                 this.seenExcerciseItemScoreBoard()
                               }
                             >
                               <div className="user-excercises_all-list__owned-list___owned-item____button-choose">
                                 <div>
                   ...
                   return (
                     <div className="user-excercises_all-list__owned-list___owned-item">
                       ...
                       <Modal
                         ...
                         onRequestClose={
                           this.closeCheckAddSuccessExcerciseItemModal
                         }
                       >
                         <div>
                           ...
                           <p style={{ fontWeight: "bold" }}>
                             Bạn đã thêm thành công Bộ đề - Bài tập này vào danh
                             sách sở hữu!!!
                           </p>
                         </div>
                         <button
                       ...
                       <Modal
                         ...
                         ariaHideApp={false}
                         isOpen={
                           this.state.checkConfirmDoExcercisesChoiceIsOpen
                         }
                         onRequestClose={
                           this.closeConfirmDoExcercisesChoiceModal
                         }
                       >
                         <div>
                           <p style={{ fontWeight: "bold", color: "red" }}>
                           ...
                           <p style={{ fontWeight: "bold" }}>
                             Khi nhấn bắt đầu làm bài bạn sẽ chuyển sang giao
                             diện làm bài và bắt đầu làm các câu hỏi có trong Bộ
                             đề - Bài tập. Bạn đã sắn sàng ???
                           </p>
                           <select
                             style={{ cursor: "pointer", outline: "none" }}
                             value={this.state.TimeToDoExcercise}
                             onChange={event =>
                               this.hanldeValueTimeToDoExcercise(event)
                             }
                           >
                       ...
                       <Modal
                         ...
                         ariaHideApp={false}
                         isOpen={
                           this.state.checkRemoveSuccessExcerciseItemIsOpen
                         }
                         onRequestClose={
                           this.closeCheckRemoveSuccessExcerciseItemModal
                         }
                       >
                         <div>
                           <p style={{ fontWeight: "bold", color: "red" }}>
                           ...
                           <p style={{ fontWeight: "bold" }}>
                             Bạn đã xóa thành công Bộ đề - Bài tập này từ danh
                             sách sở hữu!!!
                           </p>
                         </div>
                         <button
